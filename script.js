...
const products = [
    {
        ...
        price: "$149.99",
        amazonLink: "https://github.com/tanishqtt22/grabit" // <-- Replace with your affiliate link
    },
    {
        id: 2,
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (productGrid) {
        products.forEach(product => {
            ...
            // Add an event listener to the card itself (optional, as button is direct)
            card.addEventListener('click', (e) => {
                // Prevents firing when clicking the button itself
